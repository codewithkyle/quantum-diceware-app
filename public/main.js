(() => {
  ...
  // node_modules/@codewithkyle/supercomponent/supercomponent.js
  var SuperComponent = class extends HTMLElement {
    constructor() {
      super();
      this.model = {};
      this.state = "INACTIVE";
  ...
  var supercomponent_default = SuperComponent;

  // src/diceware.js
  var diceware_default = {
    11111: "abacus",
    11112: "abdomen",
    11113: "abdominal",
    11114: "abide",
  ...
  // node_modules/tooltipper/tooltipper.js
  var Tooltipper = class {
    constructor() {
      this.showTooltip = (e) => {
  ...
  var PasswordGenerator = class extends supercomponent_default {
    constructor() {
      super();
      this.addInput = () => {
      ...
      this.generate = (e) => {
        ...
        const updatedModel = {...this.model};
        updatedModel.words = [];
        const inputs = Array.from(this.querySelectorAll("input-component"));
        inputs.map((input) => {
